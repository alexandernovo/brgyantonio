<div class="modal fade" data-bs-backdrop="static" id="collectionBarangayIDModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 p-2"
            ...
            <div class="p-3">
                ...
                <form id="collectionForm">
                    ...
                    <input type="hidden" name="collection_type" id="collection_type" value="barangay_id">
