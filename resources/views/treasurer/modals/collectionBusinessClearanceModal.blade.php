<div class="modal fade" data-bs-backdrop="static" id="collectionBusinessClearanceModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 520px;">
        ...
        <div class="modal-content border-0 p-2"
            ...
            <div class="p-3">
                ...
                <form id="collectionFormBusinessClearance">

                    @csrf

                    <input type="hidden" name="collection_id" id="collection_id" value="0">
                    <input type="hidden" name="collection_type" id="collection_type" value="businessclearance">
