            ...
            <div class="card-body p-0">
                <div class="primary-bg-new d-flex justify-content-between p-3">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <button class="btn-edit-table px-4 paidUnpaidCollectionBusinessClearance active-btn"
                            data-status="Paid">
                ...
                <div class="p-3">
                    <table id="CollectionTableBusinessClearance"
                        class="table data_table table-bordered table-hover w-100 mb-0">
                        <thead>
                            <tr>
                                <th>NO.</th>
                                <th>DATE</th>
