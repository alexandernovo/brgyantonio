    ...
    <div class="page-container p-4">
        ...
        <div class="card">
            <div class="card-body p-0">
                <div class="primary-bg-new d-flex justify-content-between p-3">
                    <div class="d-flex gap-3">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <p class="mb-0 text-white" style="font-size: 25px">BARANGAY ID</p>
                        </div>
                    </div>
                    <div class="d-flex gap-3">
                        <button class="btn-edit-table px-4 paidUnpaidCollectionBarangayID" data-status="Unpaid">
                            <i class="bi bi-x-circle"></i>
                            Unpaid Payor
                        </button>
                        <button class="btn-edit-table px-4 paidUnpaidCollectionBarangayID active-btn" data-status="Paid">
                            <i class="bi bi-check-circle"></i>
                            Paid Payor
                        </button>
                        <button class="btn-add-table px-4" id="addCollectionBarangayID">
                ...
                <div class="p-3">
                    <table id="CollectionTableBarangayID" class="table data_table table-bordered table-hover w-100 mb-0">
                        <thead>
                            <tr>
                                <th>NO.</th>
                                <th>DATE</th>
...
@section('js')
    ...
    @include('treasurer.js.barangay_id')
@endsection
