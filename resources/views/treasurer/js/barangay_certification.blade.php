<script>
    ...
    function renderCollectionClearance() {
        ...
        CollectionTableCertification = new DataTable('#CollectionTableCertification', collectionClearanceOptions)
    }
    ...
    $(document).on("click", '.paidUnpaidCollectionClearance', function() {
        ...
        collectionClearanceOptions.ajax.data.status = statusCollectionCertification;
        reloadCollectionClearance();
    })
</script>
