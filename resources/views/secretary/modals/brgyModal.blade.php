<div class="modal fade" data-bs-backdrop="static" id="brgyModal" tabindex="-1" aria-labelledby="brgyModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0" style="border-radius: 15px; overflow: hidden;">
            <div class="modal-body p-2">
                <div class="text-center p-4 position-relative rounded" style="background-color: #1b3f2f;">
                    ...
                    <h3 class="text-white fw-semibold mb-0" style="letter-spacing: 1px;">BARANGAY CERTIFICATION FORM
                    </h3>
                </div>
                ...
                <div class="py-3 px-2">
                    ...
                    <form id="certificationForm" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="certification_type" value="brgy" id="certification_type">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex gap-2 w-100">
                                ...
                                <input type="text" name="municipality" id="municipality" class="form-control"
                                    value="Barbaza" style="border: 2px solid #1b3f2f; border-radius: 6px; flex: 1;">
                                <input type="text" name="province" id="province" class="form-control"
                                    value="Antique" style="border: 2px solid #1b3f2f; border-radius: 6px; flex: 1;">
                            </div>
                        </div>

                        <div class="d-flex align-items-center mb-3">
                            <label class="fw-semibold" style="width: 140px; flex-shrink: 0;">Sex:</label>
                            <div class="d-flex gap-4">
                                <div class="form-check d-flex align-items-center gap-2">
                                    <input class="form-check-input" type="radio" name="sex" id="male"
                                        value="Male"
                                        style="border: 2px solid #1b3f2f; width: 1.5em; height: 1.5em; margin-top: 0;"
                                        required>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <label class="fw-semibold" style="width: 140px; flex-shrink: 0;">Date of Birth:</label>
                            ...
                            <label class="fw-semibold text-end px-3 text-nowrap" style="width: 130px;">Place of
                                Birth:</label>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <label class="fw-semibold" style="width: 140px; flex-shrink: 0;">Nationality:</label>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <label class="fw-semibold" style="width: 140px; flex-shrink: 0;">Image:</label>
                            <div class="input-group" style="width: 750px;">
                                <label class="input-group-text text-white"
                                    style="background-color: #1A412F; border: 2px solid #1b3f2f; border-right: none; cursor: pointer;"
                                    for="image_path">Upload Image</label>
                                <input type="text" id="image_filename_display" class="form-control"
                                    placeholder="No file chosen" readonly
                                    style="border: 2px solid #1b3f2f; border-radius: 0 6px 6px 0;">
                                <input type="file" name="image_path" id="image_path" accept="image/*" hidden>
                            </div>
