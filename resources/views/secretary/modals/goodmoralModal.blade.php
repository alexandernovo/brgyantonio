<div class="modal fade" data-bs-backdrop="static" id="goodmoralModal" tabindex="-1" aria-labelledby="goodmoralModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0" style="border-radius: 15px; overflow: hidden;">
            <div class="modal-body p-2">
                <div class="text-center p-4 position-relative rounded" style="background-color: #1b3f2f;">
                    ...
                    <h3 class="text-white fw-semibold mb-0" style="letter-spacing: 1px;">GOOD MORAL CHARACTER
                        CERTIFICATION FORM
                    </h3>
                </div>
                ...
                <div class="py-3 px-2">
                    ...
                    <form id="certificationForm" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="certification_type" value="goodmoral" id="certification_type">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="form-check d-flex align-items-center gap-2 mb-0">
                                    <input class="form-check-input" type="radio" name="sex" id="female"
                                        value="Female"
                                        style="border: 2px solid #1b3f2f; width: 1.2em; height: 1.2em;">
