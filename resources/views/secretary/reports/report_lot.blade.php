            ...
            <div id="printArea">
                ...
                <div class="text-center mb-4">
                    ...
                    <h4 class="report-subtitle text-uppercase">
                        LIST OF LOT CERTIFICATION AS OF
                ...
                <div class="table-responsive px-2">
                    <table id="certificationTableBrgy" class="table custom-table table-bordered w-100 mb-0">
                        ...
                        <tbody>
                            @if (count($data) == 0)
                                <tr>
                                    <td colspan="9" class="text-center py-3 text-muted">No Data Available</td>
                                </tr>
                            @endif
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->octnumber ?? '-' }}</td>

                                    <td>{{ $item->lotnumber ?? '-' }}</td>

                                    <td>{{ $item->lotarea ?? '-' }}</td>

                                    <td>{{ $item->lotlocation ?? '-' }}</td>

                                    <td>{{ $item->taxdeclarationnumber ?? '-' }}</td>
