    ...
    <div class="page-container p-4">
        ...
        <div class="card">
            <div class="card-body p-0">
                <div class="primary-bg-new d-flex justify-content-between p-3">
                    <div class="d-flex gap-3">
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <p class="mb-0 text-white" style="font-size: 25px">CERTIFICATE OF IDIGENCY</p>
                        </div>
                    </div>
                    <div class="d-flex gap-3">
                        <button class="btn-edit-table px-4" id="editCertificationIndigency">
                            <i class="bi bi-pen-fill"></i>
                            Edit Certification
                        </button>
                        <button class="btn-add-table px-4" id="addCertificationIndigency">
                ...
                <div class="p-3">
                    <table id="certificationTableIndigency" class="table data_table table-bordered table-hover w-100 mb-0">
                        <thead>
                            <tr>
                                <th>NO.</th>
                                <th>REQUESTER</th>
...
@section('js')
    ...
    @include('secretary.js.indigencyCertification')
@endsection
