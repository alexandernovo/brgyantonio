...
@section('content')
    ...
    <div class="page-container-print p-4">
        ...
        {{-- CERTIFICATE --}}
        <div class="cert-paper px-5 pt-3 pb-4 mx-auto bg-white shadow-sm" id="printArea"
            style="
                max-width: 800px;
            ...
            <div class="text-center">
                ...
                <div style="line-height:1.2; font-size:13px;">
                    ...
                    <div class="mt-1 fw-semibold" style="color:#163d8f;">
                        BARANGAY SAN ANTONIO
                    </div>
                </div>

                {{-- TITLE --}}
                <div class="mt-2 fw-semibold text-uppercase" style="font-size:30px; letter-spacing:1px;">
            ...
            <div class="mt-4">
                ...
                <div class="text-center mb-1" style="font-size:17px;">
                    Clearance is hereby granted to:
                </div>

                {{-- OWNER --}}
                <div class="border border-dark text-center fw-semibold py-1" style="font-size:17px; border-radius:4px;">
            ...
            <div style="font-size:18px; line-height:1.8; text-align:justify;">
                ...
                <div class="fw-semibold mb-2 text-start">
            ...
            {{-- CHECKBOXES --}}
            <div class="mt-5 ms-2" style="font-size:16px; line-height:1.8;">
            ...
            <div class="d-flex justify-content-end mt-4 pe-5">
                ...
                <div class="text-center">
                    ...
                    <div class="fw-semibold text-uppercase" style="font-size:20px;">
                        HON. EVARISTO D. MALE
                    </div>
            ...
            {{-- FOOTER --}}
            <div class="mt-5" style="font-size:15px; line-height:1.5;">
