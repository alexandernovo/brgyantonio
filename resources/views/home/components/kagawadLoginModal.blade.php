<div class="modal fade" data-bs-backdrop="static" id="kagawadLoginModal" tabindex="-1" aria-labelledby="kagawadLoginModalLabel" aria-hidden="true">
                    ...
                    <div class="login-card shadow-lg">
                        ...
                        <div class="login-header text-center position-relative">
                            ...
                            <div class="profile-circle mx-auto">
                                <img src="{{ asset('assets/images/users/kagawad.png') }}" alt="Captain"
