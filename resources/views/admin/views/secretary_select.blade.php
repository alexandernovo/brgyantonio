    ...
    <div class="page-container p-4">
        <div class="top-header mb-3">
            <div class="icon-container">
                <img src="{{ asset('assets/images/users/secretary.png') }}" alt="" style="width: 40px; height: 50px;">
            </div>
            <div>
        ...
        <div class="cert-card p-2">
            <div class="card-header-green rounded">
                ...
                <h2>SECRETARY RECORDS</h2>
            </div>

            <div class="card-content">
                <label class="form-label mb-0">Document Report Type:</label>
                ...
                <div class="input-group-custom mb-2">
                    ...
                    <select class="select-field" id="doc_type">
                        <option selected disabled>Please Select</option>
                        <option>Certification</option>
                        <option>Barangay ID</option>
                        <option>Barangay RBI</option>
                        <option>Barangay OTP Quarry</option>
                    </select>
                </div>
                <label class="form-label mb-0">Certification Type:</label>
                ...
                <div class="input-group-custom">
                    ...
                    <select class="select-field disabled-input" id="cert_type">
                        <option selected disabled>Please Select</option>
...
@section('js')
    @include('admin.js.secretary_select')
@endsection
