            ...
            <div class="card-body p-2">
                ...
                <div id="printable">
                    ...
                    <table class="table-bordered border-dark table mt-3 table-reports">
                        <thead>
                            <tr>
                                <th class="text-center p-1 border-left-report border-right-report" style="font-size: 12px" style="font-size: 12px">
                                    No.
                                </th>
                                <th class="text-center p-1  border-right-report" style="font-size: 12px" style="font-size: 12px">
                                    Name of Owner
                                </th>
                                <th class="text-center p-1  border-right-report" style="font-size: 12px" style="font-size: 12px">
                                    OR Number
