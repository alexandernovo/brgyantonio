        ...
        <div class="card-body bg-white p-1" style="border-radius: 8px">
            ...
            <div id="printArea">
                ...
                <div class="text-center mb-4">
                    ...
                    <h4 class="report-subtitle text-uppercase">LIST OF BLOTTER COMPLAINTS AS
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ trim($item->respondent_first_name . ' ' . ($item->respondent_middle_name ? $item->respondent_middle_name . ' ' : '') . $item->respondent_last_name) }}
                                    </td>

                                    <td>{{ $item->nature_case ?? '-' }}</td>
                                    ...
                                    <td>
                                        {{ $item->date_of_complaints ? \Carbon\Carbon::parse($item->date_of_complaints)->format('M d, Y') : '-' }}
                                    </td>

                                    <td>
                                        {{ $item->date_of_resolve ? \Carbon\Carbon::parse($item->date_of_resolve)->format('M d, Y') : '-' }}
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="d-flex justify-content-end secretary-signature-block text-center mt-5 mb-3">
                    <div style="min-width: 250px;">
                        <h5 class="mb-0 fw-bold text-dark" style="text-transform: uppercase;">HON. EVARISTO MALE</h5>
                        <p class="text-muted mb-0" style="font-size: 15px; border-top: 1px solid #000; pt-1;">
                            Barangay Captain
                        </p>
                    </div>
                </div>
...
@section('js')
    ...
    @include('kagawad.js.printingReport')
@endsection
